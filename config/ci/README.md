...
- `RAILWAY_CI_DEBUG=1`
- detached Railway deploy upload (`railway up --detach`) followed by bounded status polling to terminal state
- verbose Railway deploy output (`railway up --detach --verbose`)
