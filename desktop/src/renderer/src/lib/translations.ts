...
const en = {
  ...
  stockComposerDescription:
    'Capture one operational update with stock observations, service flags, and storefront ordering.',
  stockComposerCancel: 'Cancel update',
  stockMerchandisingTitle: 'Merchandising order',
  stockMerchandisingDescription:
    'Set the observed storefront priority for services and sellable SKUs as part of this update.',
