...
const en = {
  ...
  stockUpdateBody:
    'Capture timestamped stock reports, optional restock or stockout signals, and review the exact evidence SIST will use for its next local analysis pass.',
  ...
  stockComposerDescription:
    'Capture one operational update with stock observations, service flags, service price edits, and ranking.',
  ...
  stockSessionDescription:
    'Complete the four required checkpoints before you submit this operational update.',
  ...
  stockSessionStepDetailsDescription:
    'Anchor the update in time and add any optional context for the floor team.',
  stockSessionStepObservations: 'Report observations',
  stockSessionStepObservationsDescription:
    'Record the SKU counts, costs, and low-effort stock signals observed in this update.',
  stockSessionStepServices: 'Service stockouts + prices',
  stockSessionStepServicesDescription:
    'Flag service stockouts and adjust service pricing as part of the same update.',
  stockSessionStepRanking: 'Ranking of Items Sold',
  stockSessionStepRankingDescription:
    'Order services and sellable SKUs based on what the team is pushing or seeing sell first.',
  stockSessionStepRequired: 'Complete every session step before submitting this update.',
  ...
  stockRankingDescription:
    'Reorder services and sellable SKUs to reflect the observed priority in this session.',
  stockSummaryTitle: 'Pending change set',
  stockReviewTitle: 'Review report before save',
  stockReviewDescription:
    'Confirm the timestamp, optional signals, and changed rows before the report is persisted into the local sparse ledger.',
