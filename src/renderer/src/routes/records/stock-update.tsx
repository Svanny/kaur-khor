...
import { filterCatalogBySupplier, type SupplierFilterValue } from '@/lib/catalog/sena-catalog';
import { timestampSortValue } from '@/lib/formatting/timestamp-sort';
import { translateUiLiteral } from '@/lib/localization/translations';
import { RECORD_UPDATE_HUB_PATH } from '@/lib/navigation/record-update-routes';
import { useInventory } from '@/state/inventory';
import { usePreferences } from '@/state/preferences';
import { PagedPanelNavigation } from '../inventory/detail-panels';
import { intervalDaysBetween, observationCompositionLabel } from '../records/observation-payload';
import { formatSenaDateTime, formatSenaLongDate, formatSenaWeekdayShort } from '../inventory/sku-detail/format';
    ...
    <WorkspacePage>
      ...
      >
        <div className="flex min-w-0 flex-col gap-3 lg:flex-row lg:flex-wrap lg:items-center lg:justify-start lg:gap-4">
          <div className="min-w-[12rem] w-full max-w-xl">
            <SearchInput
