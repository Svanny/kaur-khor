...
import { translateObservationEvidenceLabel, translateRegimeLabel } from '@/lib/localization/localized-display';
import { regimeChartFill, regimeTintedSurfaceClassName } from '@/lib/ui/state-tones';
...
import type { ChartLayoutPreferenceMergeOptions, PersistedChartLayoutPreferences } from '@/lib/chart/chart-layout-preferences';
import { PagedPanelNavigation } from '@/routes/inventory/detail-panels';
    ...
    <>
      ...
      >
        ...
        <Button asChild className="mt-4 w-full">
          <Link state={buildKaurKhorNavigationState(location, '/catalog')} to={row.href}>
