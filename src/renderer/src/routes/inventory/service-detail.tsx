...
import { normalizeServiceDetailPage } from '@/lib/sena/sena-detail-pages';
import { deriveSenaDetailCacheFreshnessFingerprint, readPersistedSenaDetailPage } from '@/lib/sena/sena-detail-page-cache';
...
import { buildRememberedCatalogHref, useRememberedPageValue } from '@/lib/settings/page-state-memory';
import { traceRenderer } from '@/lib/ui/trace';
import { usePreferences } from '@/state/preferences';
import { useInventoryActions, useInventoryState } from '@/state/inventory';
import { DetailHeroWireframe, WireframeRightRailLayout, WireframeRows } from '../inventory/loading-wireframes';
import { detailPanelGridClassName } from '../inventory/detail-panels';
