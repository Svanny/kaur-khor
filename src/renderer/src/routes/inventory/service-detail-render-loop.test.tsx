...
import { defaultChartLayoutPreferences, writeEntityChartLayoutPreferences } from '@/lib/chart/chart-layout-preferences';
import { getTranslation } from '@/lib/localization/translations';
import { NavigationHistoryProvider } from '@/state/navigation-history';
import { ServiceDetailRoute } from '../inventory/service-detail';
