...
import { matchesCatalogQuery, type CatalogView } from '@/lib/catalog/catalog';
...
import { ServiceMutationActions, SkuMutationActions } from '@/routes/inventory/catalog-item-actions';
import type { ServiceActionMode, SkuActionMode } from '@/routes/inventory/catalog-item-actions';
import { WorkspaceTitleCardWireframe } from '@/routes/inventory/loading-wireframes';
import { deriveSenaSkuDetailViewModel, type SenaSkuDetailViewModel } from '@/routes/inventory/sku-detail/view-model';
import { deriveServiceDetailViewModel, type ServiceDetailViewModel } from '@/routes/inventory/service-detail/view-model';
import { useInventory } from '@/state/inventory';
import { buildKaurKhorNavigationState } from '@/state/navigation-history';
import { usePreferences } from '@/state/preferences';
import { ArchiveRoute } from '../workspace/archive';
