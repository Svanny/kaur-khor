...
import { formatEditableNumberWithCommas, parseEditableNumberWithCommas } from '@/lib/formatting/format';
import { isBenchmarkSettingsEnabled, resolveSettingsSection } from '@/lib/navigation/settings-navigation';
...
import { HelpRoute } from '../help/help';
import { StockUpdateRoute } from '../records/stock-update';

const BenchmarkSettingsPage = isBenchmarkSettingsEnabled()
  ? lazy(() => import('../insights/benchmark-settings').then((module) => ({ default: module.BenchmarkSettingsPage })))
  : null;
