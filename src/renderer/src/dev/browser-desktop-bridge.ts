...
const demoCatalogImages = import.meta.glob<string>('../assets/dev-catalog/*.png', {
  eager: true,
  import: 'default',
  query: '?url',
});
  ...
  skus: [
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-001-phnom-penh-krama-scarf.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-002-siem-reap-rattan-tote.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-003-kampot-pepper-gift-tin.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-004-lotus-silk-hair-ribbon.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-005-tonle-sap-palm-sugar-jar.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-006-angkor-market-notebook.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-007-battambang-rice-pouch.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-008-mekong-blue-ceramic-cup.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-009-kampong-speu-honey-bottle.png'),
    ...
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-sku-010-water-festival-candle-set.png'),
  ...
  services: [
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-001-krama-gift-wrap.png'),
      price: 9,
      bundle: false,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-002-rattan-picnic-pack.png'),
      price: 52,
      bundle: true,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-003-pepper-tasting-set.png'),
      price: 24,
      bundle: false,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-004-silk-ribbon-styling-kit.png'),
      price: 28,
      bundle: true,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-005-palm-sugar-tea-pairing.png'),
      price: 22,
      bundle: true,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-006-notebook-custom-stamp-kit.png'),
      price: 20,
      bundle: false,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-007-rice-pantry-starter.png'),
      price: 18,
      bundle: true,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-008-ceramic-cup-coffee-set.png'),
      price: 32,
      bundle: true,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-009-honey-breakfast-bundle.png'),
      price: 27,
      bundle: true,
      archived: false,
    },
    {
      ...
      imagePath: demoCatalogImagePath('kaur-khor-dev-service-010-festival-candle-table-set.png'),
      price: 34,
      bundle: true,
      archived: false,
    },
