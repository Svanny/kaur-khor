  ...
  'group/field flex w-full gap-3 data-[invalid=true]:text-destructive',
  {
    variants: {
      orientation: {
        ...
        responsive:
          'flex-col *:w-full md:flex-row md:items-center md:*:w-auto md:has-[>[data-slot=field-content]]:items-start md:*:data-[slot=field-label]:flex-auto md:has-[>[data-slot=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px [&>.sr-only]:w-auto',
      },
    },
    defaultVariants: {
...
function FieldLabel({ className, ...props }: React.ComponentProps<typeof Label>) {
  return (
    <Label
      className={cn(
        'group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:border-primary/30 has-data-checked:bg-primary/5 has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col has-[>[data-slot=field]]:rounded-2xl has-[>[data-slot=field]]:border *:data-[slot=field]:p-4',
        className,
      )}
...
function FieldSeparator({
  ...
  return (
    <div className={cn('relative -my-2 h-5', className)} data-content={!!children} data-slot="field-separator" {...props}>
