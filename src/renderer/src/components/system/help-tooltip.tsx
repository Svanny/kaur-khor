...
function HelpTooltipMoreLink({
  ...
  return (
    <Link
      ...
      state={buildKaurKhorNavigationState(location)}
      to={helpHref}
    >
      <span>{moreLabel}</span>
  ...
  return (
    <HoverTooltip
      ...
      content={(
        <span>
          {content}{' '}
          <HelpTooltipMoreLink helpHref={helpHref} moreAriaLabel={moreAriaLabel} moreLabel={moreLabel} />
        </span>
      )}
      side="top"
      sideOffset={8}
