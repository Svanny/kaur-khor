...
const helperCoverageAllowlist: Record<string, string> = {
  ...
  'routes/dashboard.tsx:1714': 'queue catalog shortcut title relies on adjacent route copy',
  'routes/dashboard.tsx:1845': 'customer queue header is covered by the queue page description',
  'routes/dashboard.tsx:1846': 'customer queue header is covered by the queue page description',
  'routes/dashboard.tsx:1847': 'customer queue header is covered by the queue page description',
  'routes/dashboard.tsx:1848': 'action column contains commands rather than business meaning',
  'routes/dashboard.tsx:2038': 'supplier queue header is covered by the queue page description',
  'routes/dashboard.tsx:2039': 'supplier queue header is covered by the queue page description',
  'routes/dashboard.tsx:2040': 'supplier queue header is covered by the queue page description',
  'routes/dashboard.tsx:2041': 'action column contains commands rather than business meaning',
  ...
  'routes/stock-update-session.tsx:425': 'record-update POS stock summary header',
  'routes/stock-update-session.tsx:426': 'record-update POS stock summary header',
  'routes/stock-update-session.tsx:427': 'record-update POS stock summary header',
  ...
  'routes/stock-update-session.tsx:4585': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4675': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4697': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4813': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4841': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:5005': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:5198': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:5336': 'legacy record-update session panel awaiting helper copy',
  ...
  'routes/stock-update-session.tsx:11035': 'record-update POS timing summary surface',
  'routes/stock-update-session.tsx:11050': 'record-update POS delivery summary surface',
  'routes/stock-update-session.tsx:11068': 'record-update POS discount summary surface',
  ...
  'routes/stock-update-session.tsx:11825': 'record-update POS customer order stage header',
  'routes/stock-update-session.tsx:12112': 'record-update POS customer order stage header',
  'routes/stock-update-session.tsx:12611': 'record-update POS receipt confirmation header',
  'routes/stock-update-session.tsx:12612': 'record-update POS receipt confirmation header',
  'routes/stock-update-session.tsx:12613': 'record-update POS receipt confirmation header',
