...
const helperCoverageAllowlist: Record<string, string> = {
  ...
  'routes/service-form.tsx:180': 'loading service editor panel placeholder',
  'routes/service-form.tsx:191': 'loading service editor panel placeholder',
  'routes/service-form.tsx:198': 'loading service editor panel placeholder',
  'routes/settings.tsx:1433': 'destructive confirmation route title handled by dialog copy',
  ...
  'routes/stock-update-session.tsx:337': 'record-update loading placeholder',
  'routes/stock-update-session.tsx:335': 'record-update loading placeholder',
  'routes/stock-update-session.tsx:336': 'record-update loading placeholder',
  'routes/stock-update-session.tsx:3986': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4098': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4242': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4406': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4573': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4707': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:9483': 'legacy record-update review panel awaiting helper copy',
  'routes/stock-update-session.tsx:9498': 'legacy record-update review panel awaiting helper copy',
  'routes/stock-update-session.tsx:10033': 'legacy record-update summary panel awaiting helper copy',
  'routes/stock-update-session.tsx:10299': 'legacy record-update summary panel awaiting helper copy',
  'routes/stock-update-session.tsx:10749': 'record-update summary loading placeholder',
  'routes/stock-update-session.tsx:10750': 'record-update summary loading placeholder',
  'routes/stock-update-session.tsx:10751': 'record-update summary loading placeholder',
