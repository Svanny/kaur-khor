...
const helperCoverageAllowlist: Record<string, string> = {
  ...
  'routes/dashboard.tsx:1724': 'queue catalog shortcut title relies on adjacent route copy',
  'routes/dashboard.tsx:1855': 'customer queue header is covered by the queue page description',
  'routes/dashboard.tsx:1856': 'customer queue header is covered by the queue page description',
  'routes/dashboard.tsx:1857': 'customer queue header is covered by the queue page description',
  'routes/dashboard.tsx:1858': 'action column contains commands rather than business meaning',
  'routes/dashboard.tsx:2048': 'supplier queue header is covered by the queue page description',
  'routes/dashboard.tsx:2049': 'supplier queue header is covered by the queue page description',
  'routes/dashboard.tsx:2050': 'supplier queue header is covered by the queue page description',
  'routes/dashboard.tsx:2051': 'action column contains commands rather than business meaning',
