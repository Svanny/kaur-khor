...
const helperCoverageAllowlist: Record<string, string> = {
  ...
  'routes/automations.tsx:687': 'legacy automation empty-state title card',
  'routes/automations.tsx:702': 'legacy automation title card awaiting route-level helper copy',
  ...
  'routes/dashboard.tsx:676': 'legacy work title card awaiting route-level helper copy',
  'routes/dashboard.tsx:791': 'legacy dashboard work-table header awaiting helper copy',
  'routes/dashboard.tsx:792': 'legacy dashboard work-table header awaiting helper copy',
  'routes/dashboard.tsx:793': 'legacy dashboard work-table header awaiting helper copy',
  'routes/dashboard.tsx:794': 'action column contains commands rather than business meaning',
  'routes/dashboard.tsx:976': 'legacy dashboard supplier-table header awaiting helper copy',
  'routes/dashboard.tsx:977': 'legacy dashboard supplier-table header awaiting helper copy',
  'routes/dashboard.tsx:978': 'legacy dashboard supplier-table header awaiting helper copy',
  'routes/dashboard.tsx:979': 'action column contains commands rather than business meaning',
  'routes/financials.tsx:677': 'legacy money title card awaiting route-level helper copy',
  ...
  'routes/inventory.tsx:305': 'loading catalog panel placeholder',
  'routes/inventory.tsx:313': 'loading catalog panel placeholder',
  'routes/inventory.tsx:314': 'loading catalog panel placeholder',
  'routes/inventory.tsx:415': 'legacy catalog empty-state title card',
  'routes/inventory.tsx:439': 'legacy catalog title card awaiting route-level helper copy',
  'routes/inventory.tsx:562': 'legacy catalog grouped panel awaiting catalog helper copy',
  'routes/inventory.tsx:656': 'legacy catalog grouped panel awaiting catalog helper copy',
  'routes/loading-wireframes.tsx:54': 'loading wireframe title placeholder',
  'routes/performance.tsx:545': 'legacy pressure title card awaiting route-level helper copy',
  'routes/performance/analysis-content.tsx:222': 'legacy explain title card awaiting route-level helper copy',
  'routes/record-update-hub.tsx:646': 'legacy capture hub title card awaiting route-level helper copy',
  ...
  'routes/service-form.tsx:186': 'loading service editor panel placeholder',
  'routes/service-form.tsx:197': 'loading service editor panel placeholder',
  'routes/service-form.tsx:204': 'loading service editor panel placeholder',
  'routes/settings.tsx:1444': 'destructive confirmation route title handled by dialog copy',
  'routes/stock-update.tsx:806': 'legacy history title card awaiting route-level helper copy',
  ...
  'routes/stock-update-session.tsx:353': 'record-update loading placeholder',
  'routes/stock-update-session.tsx:354': 'record-update loading placeholder',
  'routes/stock-update-session.tsx:355': 'record-update loading placeholder',
  'routes/stock-update-session.tsx:4003': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4115': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4259': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4423': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4616': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:4754': 'legacy record-update session panel awaiting helper copy',
  'routes/stock-update-session.tsx:9693': 'legacy record-update review panel awaiting helper copy',
  'routes/stock-update-session.tsx:9708': 'legacy record-update review panel awaiting helper copy',
  'routes/stock-update-session.tsx:10254': 'legacy record-update summary panel awaiting helper copy',
  'routes/stock-update-session.tsx:10516': 'legacy record-update summary panel awaiting helper copy',
  'routes/stock-update-session.tsx:10971': 'record-update summary loading placeholder',
  'routes/stock-update-session.tsx:10972': 'record-update summary loading placeholder',
  'routes/stock-update-session.tsx:10973': 'record-update summary loading placeholder',
