...
const desktopBridge: DesktopBridge = {
  ...
  system: {
    ...
    checkForUpdate: () => invokeWithBenchmark(IPC_CHANNELS.systemCheckForUpdate),
    chooseUpdateBackupDirectory: () => invokeWithBenchmark(IPC_CHANNELS.systemChooseUpdateBackupDirectory),
    chooseUpdateDataDirectory: () => invokeWithBenchmark(IPC_CHANNELS.systemChooseUpdateDataDirectory),
    runSourceBuildUpdate: (payload: DesktopUpdateRunPayload) =>
      invokeWithBenchmark(IPC_CHANNELS.systemRunSourceBuildUpdate, payload),
