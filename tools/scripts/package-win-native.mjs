...
const electronBuilderConfig = isUnsignedLocalPackage ? 'config/package/electron-builder.unsigned-win.yml' : 'config/package/electron-builder.yml';
...
run([process.execPath, resolve(root, 'tools/scripts/stage-desktop-core.mjs'), '--platform=win32', '--arch=x64']);
