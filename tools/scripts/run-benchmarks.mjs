...
function isScenarioArg(arg) {
  return arg.endsWith('.bench.ts') || arg.includes('tests/bench/scenarios/');
}
...
const test = spawn('pnpm', ['exec', 'playwright', 'test', '-c', 'config/test/playwright.bench.config.ts', ...testArgs], {
  env: {
    ...testEnv,
  },
  stdio: 'inherit',
