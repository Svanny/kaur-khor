# Kaur Khor Web OPFS Implementation Notes
...
| Hooke | GPT-5.4 medium | Scanner D: docs/install/source-build plan | None, read-only | Completed | Produced Kaur Khor-specific install, unsigned-build, checksum, and source-build guidance. |
...
- Web runtime injects a `window.kaurKhorDesktop`-compatible bridge before rendering.
