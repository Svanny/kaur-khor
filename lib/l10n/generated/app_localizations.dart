...
abstract class AppLocalizations {
  ...
  /// Application title shown in app switchers and metadata.
  ///
  /// In en, this message translates to:
  /// **'banji Dashboard'**
  String get appTitle;

  /// Brand text shown beside the logo in the app bar.
  ///
  /// In en, this message translates to:
  /// **'banji'**
  String get appBrand;

  /// Section title for key metric cards.
  ///
  /// In en, this message translates to:
  /// **'Key Metrics'**
  String get homeKeyMetrics;

  /// Section title for performance chart.
  ///
  /// In en, this message translates to:
  /// **'Performance'**
  String get homePerformance;

  /// Section title for recent activity list.
  ///
  /// In en, this message translates to:
  /// **'Recent Activity'**
  ...
  /// Label for language setting row.
  ///
  /// In en, this message translates to:
  /// **'Language'**
  String get settingsLanguage;

  /// Label for currency setting row.
  ///
  /// In en, this message translates to:
  /// **'Currency'**
  ...
  /// Disclaimer label near info icon.
  ///
  /// In en, this message translates to:
  /// **'Disclaimer'**
  ...
  /// Language option label for Khmer.
  ///
  /// In en, this message translates to:
  /// **'Khmer (ខ្មែរ)'**
